class Solution {
    ...
    public int[] sumAndMultiply(String s, int[][] queries) {
        ...
        for (int i = 0; i < q; i++) {
            ...
            long x;
            if (count == 0) { x = 0;  } else { long leftContribution = (prefixValue[l] * pow10[count]) % MOD; x = (prefixValue[r + 1] - leftContribution + MOD) % MOD; }

      long result = (x * digitSum) % MOD;  ans[i] = (int) result;  } return ans;}}